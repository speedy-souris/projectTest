...
class TestHomeMain:
    ...
    def test_incorrect_presentation_user_to_X1(self):
        ...
        assert poor_presentation.user_behavior[poor_presentation.__class__.get_user_behavior_key(0)]
        # user_behavior['number_of_user_incivility'] = 1
        assert poor_presentation.user_behavior[
                   poor_presentation.__class__.get_user_behavior_key(5)] == 1
        # user_behavior['grandpy_status_code'] = 'mannerless'
        assert poor_presentation.user_behavior[
            poor_presentation.__class__.get_user_behavior_key(4)] == 'mannerless'
    ...
    def test_incorrect_presentation_user_to_X3(self):
        ...
        assert request.user_behavior[request.__class__.get_user_behavior_key(4)] == \
            'incivility_limit'
        # user_behavior['has_fatigue_quotas_of_grandpy'] = True
        assert request.user_behavior[request.__class__.get_user_behavior_key(3)]

    # 15) TODO indecency query (home) X1
    def test_indecency_request_user_to_X1(self):
        # incorrect request of the user ==> indecency presentation without ('bonjour'....)
        request = main.main('vieux', db_number=1)
        # has_user_indecency_status == True
        assert request.user_behavior[request.__class__.get_user_behavior_key(1)]
        ...
        assert request.user_behavior[request.__class__.get_user_behavior_key(4)] == 'disrespectful'
