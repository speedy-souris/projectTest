...
def user_incivility_count(chat_session):
    ...
    #         chat_session.__class__.get_user_behavior_key('grandpy_status_code')]\
    #         == chat_session.__class__.get_grandpy_status_key('mannerless'):
    #     print("je rentre ici avec number_incivility ="
    #           f" {chat_session.user_behavior[chat_session.__class__.get_user_behavior_key('number_of_user_incivility')]}")
    #     if chat_session.user_behavior[
    #             chat_session.__class__.get_user_behavior_key('number_of_user_incivility')] >= 3:
    #         chat_session.user_behavior[
    #             chat_session.__class__.get_user_behavior_key('number_of_user_incivility')] = 3
...
def user_indecency_count(chat_session, number_of_user_indecency):
...
def user_incomprehension_count(chat_session, number_of_user_incomprehension):
